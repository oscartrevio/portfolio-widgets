    ...
    <>
      <div className="relative flex h-48 w-1/2 flex-col gap-1 overflow-hidden rounded-3xl bg-gradient-to-b from-[#FFA800] to-[#E27614] p-5 text-white-a12 will-change-auto">
        <div className="flex justify-between">
          {coverUrl && (
            <Link href={link} target="_blank" rel="noopener noreferrer" className="relative">
              <div
                className="absolute ml-0.5 h-full w-0.5"
                style={{
                  background: "linear-gradient(90deg, rgba(0, 0, 0, 0.00) 17.39%, rgba(26, 29, 55, 0.50) 57.72%, rgba(0, 0, 0, 0.00) 101.84%)",
                }}
              />
              <Image
                src={coverUrl}
                ...
                style={{
                  boxShadow: "0px 6px 8px 0px rgba(32, 31, 49, 0.25), 0px 0px 10px 0px rgba(42, 42, 48, 0.25) inset",
                }}
              />
            </Link>
          )}
